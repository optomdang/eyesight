...
const OVERALL_COMPLETION_HELP =
  ...
  'Ngày hôm nay: chỉ tính các lượt đã tập (chưa trừ các lượt còn lại trong ngày). Ngày đã qua không tập tính 0%. Ngày bác sĩ/admin duyệt hoàn thành được tính 100%.';
